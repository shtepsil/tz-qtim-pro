        ...
        <div class="row">
            <div class="col-md-12">
                <p>
                    ...
                    пользователя "выбросит".<br><br>
                    Регистрировать можно двумя ролями: как администратор, котрый имеет возможность создавать/редактировать/удалять новости.<br><br>
                    И как обычный пользователь.<br><br>
                    В проекте есть сюрприз ))<br><br>
                    Балуйтесь !! ))
